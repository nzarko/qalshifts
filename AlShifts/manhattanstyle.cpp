...
//        QTC_ASSERT(style, /**/);
        buttonImage_pressed = QImage(":/icons/icons/pushbutton.png");
        buttonImage = QImage(":/icons/icons/pushbutton.png");

        lineeditImage = QImage(":/icons/icons/inputfield.png");
        lineeditImage_disabled = QImage(":/icons/icons/inputfield_disabled.png");
    }
